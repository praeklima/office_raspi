...
column = ['sensor/switch/f8f005d87424/15/302/JSON', 'sensor/switch/f8f005d87424/16/302/JSON',
          ...
          'sensor/switch/f8f005d87424/39/304/JSON', 'sensor/switch/f8f005d87424/37/328/JSON',
          'sensor/switch/f8f005d87424/37/327/JSON','sensor/switch/f8f005d87424/38/327/JSON']
...
openhab_item_names = ['Socket_Switch_1', 'Socket_Switch_2', 'Socket_Switch_3', 'Socket_Switch_4', 'Ventilation_Flap_switch',
                      'Slats_angle', 'Window_blinds', 'Window_opening_angle']
openhab_values = []


actuators = ['Socket_Switch_1', 'Socket_Switch_2', 'Socket_Switch_3', 'Socket_Switch_4',
    ...
    for i in range(0, len(openhab_item_names)):
        ...
        if i >= 5:
            ...
            if (value != openhab_values[i]):
                if value == 'ON':
                    openhab_values[i] = 'ON'
                    if openhab_item_names[i] == 'Ventilation_Flap_switch':
